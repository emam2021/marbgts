marbgts: Autocomplete Filenames in Sublime Text
=====================================================
...
Pressing <kbd>ctrl</kbd>+<kbd>space</kbd>, will activate marbgts.  I list of available files where be ready to select.
